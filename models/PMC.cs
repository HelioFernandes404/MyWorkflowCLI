namespace MyWorkflow
{
  public class PMC
  {
    ...
    public static void HandlePmcCommands(string[] args)
    {
    ...
    public static void ShowPmcHelp()
    {
      Console.WriteLine();
    ...
    public static void ShowTop10PmcCommands()
    {
      Console.WriteLine();
      ...
      Console.WriteLine("  Restore-NuGetPackages      Restaura os pacotes NuGet listados no arquivo packages.config");
      Console.WriteLine("  Publish-NewProject         Publica um projeto para um feed de nuget");
      Console.WriteLine();
    }

    public static void ShowDeletePmcCommands()
    {
      Console.WriteLine();
    ...
    public static void ShowEfcPmcCommands()
    {
      Console.WriteLine();
